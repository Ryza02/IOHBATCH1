...
import { Home, Table, UsersRound, Globe, User, LogIn, X, Shield } from "lucide-react";
import { useEffect } from "react";

// khusus admin
const navigation = [
  { name: "Dashboard Admin", icon: Home, href: "/dashboard-admin" },
  { name: "Manage Users", icon: UsersRound, href: "/admin/users" },
  { name: "Data Table", icon: Table, href: "/admin/table" },
  ...
  return (
    <>
      ...
      >
        ...
        <div className="py-4 text-center text-xs text-white/50">IOH Admin ©2025</div>
      </aside>
    </>
  );
}
